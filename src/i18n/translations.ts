...
export const en: Record<string, string> = {
  ...
  'log.voiceDictate': 'Dictate',
  'log.voiceStop': 'Stop',
  'log.voiceUnsupported': 'Voice input not supported on this browser',
  'log.voiceDenied': 'Microphone permission denied — allow it in browser settings',
  'log.voiceError': 'Voice input failed — check your microphone or connection and try again',
  'log.voiceFinishing': 'Finishing voice input…',
  'log.voiceFinishBeforeSubmit': 'Finish voice input before submitting the log.',
...
export const es: Record<string, string> = {
  ...
  'log.voiceDictate': 'Dictar',
  'log.voiceStop': 'Detener',
  'log.voiceUnsupported': 'Entrada de voz no compatible con este navegador',
  'log.voiceDenied': 'Permiso de micrófono denegado — actívelo en el navegador',
  'log.voiceError': 'Falló la entrada de voz — revisa el micrófono o la conexión e intenta de nuevo',
  'log.voiceFinishing': 'Finalizando entrada de voz…',
  'log.voiceFinishBeforeSubmit': 'Finaliza la entrada de voz antes de enviar el reporte.',
